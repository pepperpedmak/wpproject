    ...
    <>
      ...
      <div className="min-h-screen flex">
        ...
        <div className="w-screen bg-white shadow-md">
          <Navbar />
          <main className="container mx-auto p-4 grid grid-cols-4 gap-8">
            <section className="to-do bg-purple-100 p-6 rounded-md">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-bold">TO DO</h2>
                <div className ="flex justify-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
            ...
            <section className="in-progress bg-blue-100 p-6 rounded-md">
            <div className="flex justify-between items-center mb-6">
            ...
            <section className="testing bg-yellow-100 p-6 rounded-md">
            <div className="flex justify-between items-center mb-6">
